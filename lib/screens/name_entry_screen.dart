...
class _NameEntryScreenState extends State<NameEntryScreen>
  ...
  // A handful of sparks — same as home screen, just fewer
  ...
  void initState() {
    ...
    for (int i = 0; i < 10; i++) {
      _sparks.add(_Spark(
        ...
        opacity: _rng.nextDouble() * 0.30 + 0.08,
        color:
          ...
          children: [
            ...
            ...List.generate(_sparks.length, (i) {
              ...
              return AnimatedBuilder(
                ...
                builder: (_, __) {
                  final yOff = sin(
                        _floatController.value * 2 * pi + sp.phase,
                      ) *
                      18 *
                      sp.speed;
                  return Positioned(
                          ...
                          child: ConstrainedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                // Header with shimmer on accent word
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text(
                                ...
                                // Divider row — same style as splash screen
                                Row(
                                  children: [
                                    _divLine(),
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            // Bottom line — animates cyan when active
                                            AnimatedContainer(
                                ...
                                // Footer label — same as home screen
                                Center(
                                  child: AnimatedBuilder(
                                    animation: _shimmerController,
                                    builder: (_, __) => ShaderMask(
...
// ── Same spark data class used in HomeScreen ─────────────────────
class _Spark {
