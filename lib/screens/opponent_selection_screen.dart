              ...
              builder: (context, constraints) {
                ...
                return Center(
                  child: ConstrainedBox(
                    ...
                    // ✅ FIX 2: Column + Padding instead of SingleChildScrollView
                    // so Spacer works and content fills the screen properly
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // ✅ FIX 5: Spacer pushes footer to bottom
                          const Spacer(),
  ...
  Widget _buildOpponentCard(
    ...
    return Material(
      ...
      child: InkWell(
        ...
        onTap: onTap,
        child: Container(
          // ✅ FIX 6: vertical padding reduced — was 24, cards felt too tall/square
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(icon, size: 26, color: AppTheme.primary), // was 30
              ),
              const SizedBox(width: 16), // was 18
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
              ...
              Container(
                ...
                child: Icon(Icons.arrow_forward_rounded,
                    color: AppTheme.primary, size: 20), // was 24
              ),
            ],
          ),
        ),
